...
```
```{r echo=FALSE, fig.align='center', fig.cap='', out.width='100%'}knitr::include_graphics('https://github.com/matthewpaley/Spotify2/tree/master/images/Danceability.jpeg')
```
...
knitr::include_graphics('https://github.com/matthewpaley/Spotify2/tree/master/images/All%20Features.jpeg')
```
