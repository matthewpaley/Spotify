...
knitr::include_graphics('https://github.com/matthewpaley/Spotify2/tree/master/images/danceability.png')
```
...
```{r echo=FALSE, fig.align='center', fig.cap='', out.width='100%'}
knitr::include_graphics('https://github.com/matthewpaley/Spotify2/tree/master/images/all_features.png')
```
