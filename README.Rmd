...
```
![all_features](https://github.com/matthewpaley/Spotify2/tree/master/images/all_features.png)
...
```{r, echo=FALSE}
htmltools::tags$iframe(title = "My embedded document", src = 'https://github.com/matthewpaley/Spotify2/blob/master/images/song_preview_plot.html?raw=true')
```
